...
def execute(config: GlobalConfig, logger: StructuredLogger, run_id: str, trace_id: str):
    ...
    if task_type == "A":
        ...
        for chunk in chunks:
            ...
            try:
                logger.worker_state(trace_id, "monolithic", worker_id, "busy")
                # Crash check
                ...
                if latency_sec > 0:
                    logger.worker_state(trace_id, "monolithic", worker_id, "blocked")
                ...
                logger.worker_state(trace_id, "monolithic", worker_id, "idle")
